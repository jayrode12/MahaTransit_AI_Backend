...
class StorageService:
    ...
    def get_destination_bucket(cls, attachment_type: str) -> str:
        ...
        if attachment_type == "audio":
            return getattr(settings, "SUPABASE_VOICE_BUCKET", "voice-files") or "voice-files"
        return getattr(settings, "SUPABASE_ATTACHMENTS_BUCKET", "attachments") or "attachments"
